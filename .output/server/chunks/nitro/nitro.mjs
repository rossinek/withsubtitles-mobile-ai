...
class PunctuateService {
  ...
  static async initialize(progress_callback) {
...
__publicField(PunctuateService, "instance", null);
...
const _cxKKDE = eventHandler((event) => {
...
export { PunctuateService as P, createError$1 as a, config as c, defineEventHandler as d, getHeader as g, nodeServer as n, readBody as r };
